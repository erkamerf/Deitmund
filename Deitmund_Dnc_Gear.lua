...
function init_gear_sets()
    ...
    sets.precast.Waltz = {ammo="Yamarang",
        head="Mummu Bonnet +1",neck="Etoile Gorget",ear1="Enchntr. Earring +1",ear2="Sjofn Earring",
    ...
    sets.precast.Step = {ammo="C. Palug Stone",
        ...
        back=gear.stp_jse_back,waist="Olseni Belt",legs="Meg. Chausses +1",feet="Malignance Boots"}
	...
	sets.precast.WS.Acc = set_combine(sets.precast.WS, {ammo="C. Palug Stone",neck="Combatant's Torque",ear1="Telos Earring",body="Meg. Cuirie +1",waist="Olseni Belt",legs="Meg. Chausses +1",feet="Malignance Boots"})
	sets.precast.WS.FullAcc = set_combine(sets.precast.WS, {ammo="C. Palug Stone",neck="Combatant's Torque",ear1="Telos Earring",body="Meg. Cuirie +1",waist="Olseni Belt",legs="Meg. Chausses +1",feet="Malignance Boots"})
    ...
    sets.precast.WS["Rudra's Storm"].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="C. Palug Stone",head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",body="Meg. Cuirie +1",legs=gear.herculean_wsd_legs})
    sets.precast.WS["Rudra's Storm"].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",body="Meg. Cuirie +1"})
    ...
    sets.precast.WS["Shark Bite"].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",body="Meg. Cuirie +1",legs=gear.herculean_wsd_legs})
    sets.precast.WS["Shark Bite"].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",body="Meg. Cuirie +1"})
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {ammo="Charis Feather",head="Adhemar Bonnet +1",neck="Fotia Gorget",body="Abnoba Kaftan",hands="Mummu Wrists +1",ring1="Begrudging Ring",waist="Fotia Belt",feet="Mummu Gamash. +1"})
    sets.precast.WS['Evisceration'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Adhemar Bonnet +1",neck="Fotia Gorget",body="Abnoba Kaftan",hands="Mummu Wrists +1",ring1="Begrudging Ring",waist="Fotia Belt",legs="Mummu Kecks +1",feet="Mummu Gamash. +1"})
	...
	sets.defense.MEVA = {ammo="Staunch Tathlum +1",
		...
		back="Mujin Mantle",waist="Engraved Belt",legs="Meg. Chausses +1",feet="Ahosi Leggings"}
	...
	sets.engaged.Acc = {ammo="Yamarang",
        ...
        back=gear.stp_jse_back,waist="Reiki Yotai",legs="Meg. Chausses +1",feet="Malignance Boots"}
    ...
    sets.engaged.PDT = {ammo="Staunch Tathlum +1",
        ...
        body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Defending Ring",ring2="Moonlight Ring",
        back="Moonlight Cape",waist="Flume Belt +1",legs="Meg. Chausses +1",feet="Ahosi Leggings"}
    ...
    sets.engaged.FullAcc.PDT = {ammo="Staunch Tathlum +1",
        head="Dampening Tam",neck="Loricate Torque +1",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Defending Ring",ring2="Patricius Ring",
        back="Moonlight Cape",waist="Olseni Belt",legs="Meg. Chausses +1",feet="Ahosi Leggings"}
		
    sets.engaged.Fodder.PDT = {ammo="Staunch Tathlum +1",
        head="Dampening Tam",neck="Loricate Torque +1",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Defending Ring",ring2="Dark Ring",
        back="Moonlight Cape",waist="Flume Belt +1",legs="Meg. Chausses +1",feet="Malignance Boots"}

    -- Buff sets: Gear that needs to be worn to actively enhance a current player buff.
    sets.buff['Saber Dance'] = {} --legs="Horos Tights"
    sets.buff['Climactic Flourish'] = {ammo="Charis Feather",head="Adhemar Bonnet +1",body="Meg. Cuirie +1"} --head="Charis Tiara +2"
